...
function setupEventListeners() {
    // 内容变化时更新预览
    document.getElementById('processed-editor').addEventListener('input', updatePreview);
}

// 更新预览
function updatePreview() {
    const content = document.getElementById('processed-editor').value;
    ...
    document.getElementById('processed-preview').innerHTML = html;
}
